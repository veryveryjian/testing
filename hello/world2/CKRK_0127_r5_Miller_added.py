...
order_mi = ['Chartlon Cabinetry', 'Chunghua Cabinet NJ', 'Chunghua CT', 'Charlton Cabinetry PA']
...
mi = pd.read_csv("C:\\Users\\charlton\\Desktop\\CKRK\\mi.CSV", encoding='ISO-8859-1')
...
mi = sort_and_categorize(mi, order_mi, 'MI')
...
mi = mi.reindex(columns=desired_column_order)
...
with pd.ExcelWriter(excel_path, engine='xlsxwriter') as writer:
    ...
    mi.to_excel(writer, sheet_name='MI', index=False)
