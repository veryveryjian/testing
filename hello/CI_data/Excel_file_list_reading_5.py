# 바탕화면에 파일을 생성함 CI_Create
# 그냥 바탕화면에 생성했을 뿐이네, _INVOICE_filtered.xlsx 이것과 동일
...
output_directory = r'C:\Users\charlton\Desktop\CI_Create_123'
...
for file in excel_files:
    ...
    try:
        ...
        new_file_path = os.path.join(output_directory, f"{os.path.splitext(file)[0]}_INVOICE_f1.xlsx")
