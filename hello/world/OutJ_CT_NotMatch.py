...
merged_data2 = pd.merge(ct_invoice_data_nj, po_ny_data, on=['Type', 'Date', 'Num'], how='outer')
...
#합계값
total_debit = ct_invoice_data_nj['Debit'].sum()
...
#ct
merged_data3 = pd.merge(ct_invoice_data_ct, po_nj_data, on=['Type', 'Date', 'Num'], how='outer')
...
#합계값
total_debit_ct = ct_invoice_data_ct['Debit'].sum()
...
#####
merged_data4 = pd.merge(ct_invoice_data_pa, po_pa_data, on=['Type', 'Date', 'Num'], how='outer')
...
#합계값
total_debit_pa = ct_invoice_data_pa['Debit'].sum()
