...
merged_data2 = pd.merge(ny_invoice_data_nj, po_nj_data, on=['Type', 'Date', 'Num'], how='outer')
...
#합계값
total_debit = ny_invoice_data_nj['Debit'].sum()
total_credit = po_nj_data['Credit'].sum()
# 차액 계산
